    ...
    driveCar: function(){
            ...
            'keydown', function(e){
                ...
                if (e.code=="ArrowUp"){
                    ...
                    if (multiply<=100 && cameraPosition.z>-500){
                        ...
                        var accelrateCar = document.querySelector("#controlacc")
                        accelrateCar.setAttribute("material","color", "green")
                ...
                if (e.code=="Space"){
                    ...
                    var stopCar = document.querySelector("#controlbrake")
        ...
        window.addEventListener("keyup", function(e){
            ...
            if(e.code=="ArrowUp"){
                ...
                var accelrateCar = document.querySelector("#controlacc")
                accelrateCar.setAttribute("material","color", "gray")
            }
        })
    }
}) 
